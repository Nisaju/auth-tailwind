    ...
    <div className="bg-[#ECF0F4] min-h-screen font-poppins">
      <div className="pt-10">
        <div className="mt-6 lg:mt-[50px] font-sans mx-4 lg:mx-[110px]">
          <div className="w-full md:w-1/2 lg:w-1/2 2xl:w-1/4 container mx-auto my-[50px] bg-white border border-[#EAEAEA] py-[58px] px-[25px] lg:px-[50px] rounded-xl">
            <svg
              viewBox="0 0 165 66"
              className="fill-[#6700eb] w-[100px] h-[50px] lg:w-[150px] lg:h-[75px] mx-auto mb-4"
            >
            ...
            <h1 className="font-medium text-2xl lg:text-3xl text-center text-[#19212C] font-alegreya lg:mt-1 mb-4">
              Create an Account
            </h1>
            <Form
              submitText="Sign In"
              ...
              onSubmit={onSubmit}
              buttonClassName="w-full py-3.5 mt-[50px] bg-[#77C5FD] text-white text-lg font-bold rounded-lg"
            >
              <LabeledTextField
                name="email"
                label="Email"
                placeholder="Email"
                autoComplete="off"
                labelClassName="text-[#4f5255] text-lg flex flex-col"
              />
              <LabeledTextField
                name="password"
                label="Password"
                ...
                labelClassName="text-[#4f5255] text-lg flex flex-col"
              />
              <div className="text-right mt-2.5 underline font-light text-base text-[#868B90]">
            ...
            <Link href={Routes.SignupPage()}>
              <a className="block text-center mt-[30px] underline font-light text-base text-[#868B90]">
                Create New Account
              </a>
            </Link>
          </div>
