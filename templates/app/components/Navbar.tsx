...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="w-full bg-gray-100 flex justify-between items-center px-3 md:px-6 py-2 md:py-4">
        <Logo className="fill-[#6700eb] w-[100px] h-[50px] lg:w-[150px] lg:h-[75px]" />
        <button
          type="button"
        ...
        <div className="hidden md:flex justify-end items-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="fill-[##a0aec0] hover:text-gray-400"
          >
            <svg
              viewBox="0 0 20 20"
              focusable="false"
              className="mx-4 w-5 h-5 block leading-4 flex-shrink-0 transition-colors duration-200"
            >
              <path
                fill="currentColor"
      ...
      <div className="md:hidden relative w-full">
        <div
          className={[
            "flex flex-col space-y-4 justify-end items-center bg-gray-100 absolute right-0 left-0 py-4",
            isOpen ? "top-0" : "-top-96",
          ].join(" ")}
        >
          <a
